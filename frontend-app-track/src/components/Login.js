    ...
    render() {
        return (
            ...
            <form onSubmit={(e) => this.handleLogin(e)}>
                ...
                <button type="submit" className="btn btn-dark btn-sm btn-block">Log In</button>
                <button  onClick={this.props.toggleForm} className="btn btn-dark btn-sm btn-block">Create an Account?</button>
